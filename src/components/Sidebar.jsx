...
import Ellipse from "../assets/Ellipse.png";
import { FaGraduationCap } from "react-icons/fa";
import { DashboardOutlined, TeamOutlined, UserOutlined, CreditCardOutlined, SettingOutlined, FileDoneOutlined } from "@ant-design/icons";

const Sidebar = () => {
  return (
    <div className="w-[250px] bg-[#0B1C49] text-white p-6 flex flex-col justify-between">
      <div>
        <div className="mb-8 border-b border-gray-300 pb-4">
          <img src={Ellipse} alt="Profile" className="w-10 h-10 mb-4 mx-auto" />
      ...
      <div className="text-sm text-white">
        <span className="flex items-center gap-3 text-white py-1 px-2 rounded text-center">
          <FaGraduationCap className="w-6 h-6 text-white-700" />
          Features{" "}
          <span className="bg-blue-600 px-1 rounded text-xs text-black py-[5px] px-[10px]">NEW</span>
        </span>
      </div>
    </div>
  );
