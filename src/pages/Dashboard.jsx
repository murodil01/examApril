  ...
  return (
    <div className="flex gap-x-[147px] h-screen">
      ...
      <div className="flex-1 bg-white p-8 relative overflow-auto">
        ...
        <button className="flex gap-2 items-center absolute bottom-6 right-6 bg-[#1B2B65] text-white px-6 py-5 rounded-full shadow-lg sm:right-4 sm:px-4 sm:py-3 sm:text-sm">
