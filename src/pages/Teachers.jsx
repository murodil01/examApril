...
const Teachers = () => {
  ...
  const handleSave = () => {
    const newTeacher = { ...formData, key: teachers.length };
    ...
    <div className="flex flex-col md:flex-row gap-6">
      ...
      >
        <div className="flex w-full h-full">
          <Sidebar />
          <div className="flex flex-col w-full ml-6 overflow-auto p-6">
            <div className="flex justify-between items-center">
              <h2 className="text-lg font-semibold mb-4">Add Teacher</h2>
              <Button type="primary" className="py-[12px] px-[14px]" onClick={handleSave}>
                Save
              </Button>
            </div>
